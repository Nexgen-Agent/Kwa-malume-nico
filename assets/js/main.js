/* Malume Nico - Home - Complete with Liquid Light */
document.addEventListener("DOMContentLoaded", function() {
  ...
  // ========================
  // LIQUID LIGHT BEAMS FUNCTIONALITY
  // ========================
  ...
  // Add random slight delay to light beams for more natural effect
  ...
  setTimeout(randomizeLightBeams, 1000);
  
  // Check user motion preference
  adjustAnimationSpeed();

  // Re-check motion preference if it changes
...
// Fallback for carousels (outside DOMContentLoaded)
setTimeout(() => {
  const carousels = document.querySelectorAll('.fade-carousel');
